...
swap_router_address = "0x1b81D678ffb9C0263b24A97847620C99d213eB14" # swap router v3, bsc testnet
swap_router_contract = w3.eth.contract(address=swap_router_address, abi=swap_router_abi)

# parameters for the swap
params = {
  "tokenIn": Web3.to_checksum_address("0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd"), # tBNB, now its WBNB
  ...
  "amountOutMinimum": w3.to_wei(0.001, "ether"), # minimum of USDT you are willing to receive
